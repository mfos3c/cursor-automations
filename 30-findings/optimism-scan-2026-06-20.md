...
date: "2026-06-20"
status: status/skip
updated: "2026-06-20T20:01:57.589Z"
---
...
| Triggered at (UTC) | `2026-06-20T20:01:57.589Z` |
...
- MCP discovery for mandatory `web3-bbp-rag` was attempted via `GetMcpTools` pattern search (`web3-bbp-rag|web3|bbp|rag`); only `obsidian-web3` was available.
- Direct lookup (`GetMcpTools` server: `web3-bbp-rag`) failed with `server not found`.
- This file was refreshed by the `2026-06-20T20:01:57.589Z` cron trigger (same date-level slug path).
