...
- Daily pick for today (`[[20-bounties/daily-pick-2026-06-18]]`) was not present in git workspace.
- Fallback rule applied from `automations/bb-scan-prompt.md`: use most recent available daily pick.
